...
const ReclaimRequest = () => {
  ...
  const { baseUrl, uploadConfig, GetAllReclaims, getDashboardDetails } =
    useStateContext();
  ...
  const { details, date_of_expenses, amount_to_reclaim, proof_of_reclaim } =
    form;
      ...
      <form onSubmit={handleSubmit} className="">
        <div className="ml-10 mr-10 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="mb-4">
            ...
            />
            {errors.details && (
              <p className="text-red-600 font-bold">{errors.details}</p>
            )}
          </div>
        ...
        <div className="w-full flex justify-center items-center">
          <Button
            type="submit"
            className="w-full md:w-[27rem] h-12 flex justify-center items-center"
          >
