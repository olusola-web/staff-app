...
const registrationSchema = Yup.object().shape({
  ...
  guarantor_full_name: Yup.string().required('Please enter your Guarantor Full Name'),
  guarantor_phone: Yup.string().required('Please enter your Guarantor Phone No'),
  guarantor_address: Yup.string().required('Please enter your Guarantor Address'),
});
  ...
  <React.Fragment>
    ...
    <form onSubmit={formik.handleSubmit}>
        ...
        <label className="flex-1 block mb-2 md:mr-4 text-sm font-medium">
          ...
          <label className="flex-1 block mb-2 text-sm font-medium">
            Sex
            <select className="w-full p-4 bg-gray-100 focus:outline-none rounded-md" name="sex"
