...
const ProfileForm = () => {
 ...
 const [formData, setFormData] = useState({
  ...
  const registrationSchema = Yup.object().shape({
    ...
    guarantor_full_name: Yup.string().required(
      "Please enter your Guarantor Full Name"
    ),
    guarantor_phone: Yup.string().required(
      "Please enter your Guarantor Phone No"
    ),
    guarantor_address: Yup.string().required(
      "Please enter your Guarantor Address"
    ),
  });
  ...
  return (
    <React.Fragment>
      <div className="mx-auto mt-0 p-4 bg-white">
        ...
        <h2 className="text-2xl font-bold mb-7 mt-5">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <div className="md:flex md:justify-between">
            ...
            <label className="flex-1 block mb-2 text-sm font-medium">
              Sex
              <select
                className="w-full p-4 bg-gray-100 focus:outline-none rounded-md"
                name="sex"
          ...
          <div className="md:flex md:justify-between">
            ...
            <label className="flex-1 block mb-2 text-sm font-medium">
              ...
              <a
                className="text-green-600 italic ml-5"
                href={`${imgUrl}/${profileDetails?.profile_picture}`}
                target="__blank"
              >
                view
              </a>
          ...
          <label className="flex-1 block mb-2 text-sm font-medium ">
            ...
            />
            {formik.errors.cv && (
              <div style={{ color: "red" }}>{formik.errors.cv}</div>
            )}
          </label>
          ...
          <div className="md:flex md:justify-between">
            <label className="flex-1 block mb-2 md:mr-4 text-sm font-medium">
              ...
              />
              {formik.errors.guarantor_full_name && (
                <div style={{ color: "red" }}>
                  {formik.errors.guarantor_full_name}
                </div>
              )}
          ...
          <div className="md:flex md:justify-between">
            ...
            <label className="flex-1 block mb-2 text-sm font-medium">
              ...
              <a
                className="text-green-600 italic ml-5"
                href={`${imgUrl}/${profileDetails?.guarantor_photo}`}
                target="__blank"
              >
                view
              </a>
